...
This project is based on Python Robotics Simulator developed by [Student Robotics](https://studentrobotics.org).
...
* Robot could be controlled more smoothly, without stopping rapidly

* Collision handling with the blocks on the way
